...
describe('interactions Dogflix', () => {
  ...
  it('effectue une recherche instantanée', async () => {
    ...
    await userEvent.type(field, 'Paloma')
    expect(screen.getByText(/5 résultats reniflés/)).toBeInTheDocument()
    expect(screen.getAllByLabelText(/Voir les détails de Paloma/)).toHaveLength(5)
  })
})
